    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Принят', 'Принят'), ('Отклонен', 'Отклонен'), ('В ожидании', 'В ожидании')], default='В ожидании')),
                ('type', models.CharField(choices=[('Перемешения', 'Перемешения'), ('По накладной', 'По накладной')])),
            ],
            options={
